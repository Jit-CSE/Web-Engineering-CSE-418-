   ...
   <?php require 'message.php'; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-xs-6 mb-5" style="width: 60%">
                <div class="card">
                    <img src="https://cdn2.bigcommerce.com/server3500/o09rtt/product_images/uploaded_images/-blood-003.png?t=1575468585" class="card-img-top">
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <i class="fa fa-mobile"> </i> <a > +8801952068135</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    Visit here to get more health tips in Bengoli.
                    <a href="https://bdhealth.org/" target="_blank"> bdhealth</a>
                </div>
            </div>
            </div>
        </div>
